...
const SHELL = [
  ...
  './js/views/profile.js', './js/views/cards.js', './js/views/landing.js',
  './manifest.json',
  // Canonical, STABLE icon filenames — these never change again (see progress.md icon policy).
